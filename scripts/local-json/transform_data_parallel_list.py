...
async def main():
    ...
    all_transformed_data = [item for result in all_results if result for item in result]
    
    with open('transformed_data_parallel_list.json', 'w', encoding='utf-8') as outfile:
